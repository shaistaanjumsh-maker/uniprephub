...
class SettingRepository extends Repository
{
    ...
    public static function updateByRequest(SettingUpdateRequest $request, Setting $setting)
    {
        ...
        $paymentQRCode = $request->hasFile('payment_qr_code') ? MediaRepository::updateOrCreateByRequest(
            $request->file('payment_qr_code'),
        ...
        return self::update($setting, [
            ...
            'payment_upi_id' => $request->payment_upi_id ?? $setting->payment_upi_id,
            'payment_whatsapp' => $request->payment_whatsapp ?? $setting->payment_whatsapp,
            'payment_qr_code_id' => $paymentQRCode ? $paymentQRCode->id : null,
        ]);
    }
}
