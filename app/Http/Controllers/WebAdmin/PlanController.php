...
class PlanController extends Controller
{
    ...
    public function store(PlanRequest $request)
    {
        ...
        return to_route('admin.plan.index')->withSuccess('New Plan created successfully.');
    }
    ...
    public function update(PlanRequest $request, Plan $plan)
    {
        ...
        return to_route('admin.plan.index')->withSuccess('Plan updated successfully.');
    }

    public function destroy(Plan $plan)
    {
        $plan->delete();
        return to_route('admin.plan.index')->withSuccess('Plan deleted successfully.');
    }
    ...
    public function restore($planId)
    {
        ...
        return to_route('admin.plan.index')->withSuccess('Plan restored successfully.');
    }
    ...
    public function publish(Request $request)
    {
        ...
        return to_route('admin.plan.index')->withSuccess('Plan published successfully.');
    }
}
