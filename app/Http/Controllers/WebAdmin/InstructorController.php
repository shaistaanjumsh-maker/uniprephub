...
class InstructorController extends Controller
{
    ...
    {
        if ($user->instructor) {
            return to_route('admin.instructor.index')->withSuccess('User is already an instructor');
        }
        ...
        return to_route('admin.instructor.index')->withSuccess('Promoted to instructor');
    }
    ...
    public function store(InstructorStoreRequest $instructorRequest, UserStoreRequest $userRequest)
    {
        ...
        return to_route('admin.instructor.index')->with('success', 'Instructor created');
    }
    ...
    public function update(InstructorUpdateRequest $instructorRequest, UserUpdateRequest $userRequest, Instructor $instructor)
    {
        if (app()->isLocal() && $instructor->user->is_admin) {
            return to_route('admin.instructor.index')->withError('Admin cannot be updated in demo mode');
        }
    ...
    public function destroy(Instructor $instructor)
    {
        ...
        return redirect()->route('admin.instructor.index')->withSuccess('Instructor deleted');
    }
    ...
    public function restore(int $id)
    {
        ...
        return redirect()->route('admin.instructor.index')->withSuccess('Instructor restored');
    }
}
