...
class ManageCertificateController extends Controller
{
    ...
    public function update(ManageCertificateRequest $request)
    {
        ...
        if ($request->hasFile('frame_id')) {
            ...
            return to_route('admin.certificate.index')->withSuccess('Frame updated');
        }

        ManageCertificateRepository::updateByRequest($request, $certificate);

        return to_route('admin.certificate.index')->withSuccess('Configaration updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $frame->delete();
        return to_route('admin.certificate.index')->withSuccess('Frame deleted successfully');
    }
}
