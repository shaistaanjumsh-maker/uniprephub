...
class ExamController extends Controller
{
    ...
    public function store(ExamStoreRequest $request)
    {
        ...
        return to_route('admin.exam.index', ['course' => $exam->course_id])->with('success', 'Exam created');
    }
    ...
    public function update(ExamUpdateRequest $request, Exam $exam)
    {
        ...
        return to_route('admin.exam.index', ['course' => $exam->course_id])->withSuccess('Exam updated');
    }
    ...
    public function destroy(Exam $exam)
    {
        ...
        return redirect()->route('admin.exam.index', ['course' => $courseId])->withSuccess('Exam deleted');
    }
}
