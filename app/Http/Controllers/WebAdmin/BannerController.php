...
class BannerController extends Controller
{
    ...
    public function store(OfferBannerRequest $request)
    {
        ...
        return to_route('admin.banner.index')->withSuccess('Banner created successfully.');
    }
    ...
    public function update(OfferBannerUpdateRequest $request, $id)
    {
        ...
        return to_route('admin.banner.index')->withSuccess('Banner updated successfully.');
    }
    ...
    public function delete($id)
    {
        $banner = OfferBannerRepository::findOrFail($id);
        $banner->delete();
        return to_route('admin.banner.index')->withSuccess('Banner deleted successfully.');
    }
    ...
    public function publish(Request $request)
    {
        ...
        return to_route('admin.banner.index')->withSuccess('Banner published successfully.');
    }
