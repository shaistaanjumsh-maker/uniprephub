...
class CouponController extends Controller
{
    ...
    public function store(CouponStoreRequest $request)
    {
        ...
        return to_route('admin.coupon.index')->with('success', 'Coupon created');
    }
    ...
    public function update(CouponUpdateRequest $request, Coupon $coupon)
    {
        ...
        return to_route('admin.coupon.index')->withSuccess('Coupon updated');
    }
    ...
    public function destroy(int $id)
    {
        ...
        return redirect()->route('admin.coupon.index')->withSuccess('Coupon deleted');
    }
}
