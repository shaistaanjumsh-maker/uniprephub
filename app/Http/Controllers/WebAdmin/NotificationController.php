...
class NotificationController extends Controller
{
    ...
    public function switchStatus(Notification $notification)
    {
        ...
        return to_route('admin.notification.index')->withSuccess('Notification status updated');
    }
    ...
    public function update(NotificationUpdateRequest $request, Notification $notification)
    {
        ...
        return to_route('admin.notification.index')->withSuccess('Notification updated');
    }
