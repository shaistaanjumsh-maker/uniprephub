...
class QuizController extends Controller
{
    ...
    public function store(QuizStoreRequest $request)
    {
        ...
        return to_route('admin.quiz.index', ['course' => $quiz->course_id])->with('success', 'Quiz created');
    }
    ...
    public function update(QuizUpdateRequest $request, Quiz $quiz)
    {
        ...
        return to_route('admin.quiz.index', ['course' => $quiz->course_id])->withSuccess('Quiz updated');
    }
    ...
    public function destroy(Quiz $quiz)
    {
        ...
        return redirect()->route('admin.quiz.index', ['course' => $courseId])->withSuccess('Quiz deleted');
    }
}
