...
class CourseController extends Controller
{
    ...
    public function store(CourseStoreRequest $request)
    {
        ...
        return to_route('admin.course.index')->with('success', 'Course created');
    }
    ...
    public function update(CourseUpdateRequest $request, Course $course)
    {
        ...
        return to_route('admin.course.index')->withSuccess('Course updated');
    }
    ...
    public function delete(Course $course)
    {
        ...
        return redirect()->route('admin.course.index')->withSuccess('Course deleted');
    }
    ...
    public function restore(int $id)
    {
        ...
        return redirect()->route('admin.course.index')->withSuccess('Course restored');
    }
