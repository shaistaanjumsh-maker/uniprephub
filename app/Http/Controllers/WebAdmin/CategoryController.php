...
class CategoryController extends Controller
{
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return to_route('admin.category.index')->with('success', 'Category created');
    }
    ...
    public function update(CategoryUpdateRequest $request, Category $category)
    {
        ...
        return to_route('admin.category.index')->withSuccess('Category updated');
    }
    ...
    public function restore(int $id)
    {
        ...
        return redirect()->route('admin.category.index')->withSuccess('Category restored');
    }
