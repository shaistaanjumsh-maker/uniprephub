...
class User extends Authenticatable implements JWTSubject, MustVerifyEmail
{
    ...
    public function premiumEnrollments(): HasMany
    {
        return $this->hasMany(PremiumEnrollment::class, 'user_id');
    }

    public function premiumCourses(): BelongsToMany
    {
        return $this->belongsToMany(PremiumCourse::class, 'premium_enrollments', 'user_id', 'course_id');
    }
