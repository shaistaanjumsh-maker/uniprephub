...
class Setting extends Model
{
    ...
    {
        return $this->belongsTo(Media::class, 'payment_qr_code_id');
    }

    public function paymentQRPath(): Attribute
    {
        $path = null;

        if ($this->paymentQR && Storage::exists($this->paymentQR->src)) {
            $path = Storage::url($this->paymentQR->src);
        }
