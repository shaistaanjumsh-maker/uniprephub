...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        SettingRepository::query()->updateOrCreate([
            ...
            'footer_text' => $setting?->footer_text ?? 'Developed by Uniprep',
            'footer_contact_number' => $setting?->footer_contact_number ?? '80-021',
            'footer_support_mail' => $setting?->footer_support_mail ?? 'support@uniprep.com',
