        ...
        <div class="app-sidebar-inner border-top">
            <ul class="vertical-nav-menu">
                ...
                @elseif(Auth::user()->hasRole('instructor'))
                    ...
                    <li>
                        <a class="menu {{ request()->is('admin') ? 'active' : '' }}" href="{{ route('home') }}">
                            <span>
                                <img class="menu-icon" src="{{ asset('assets/images/menu/home-roof.svg') }}" alt="icon" loading="lazy" />
                                {{ __('Dashboard') }}
                            </span>
                    ...
                    <div class="collapse dropdownMenuCollapse {{ request()->is('admin/setting*', 'admin/certificate/*', 'admin/permission&role/*', 'admin/language*', 'admin/payment-gateway*') ? 'show' : '' }}"
                        ...
                        <div class="listBar">
                            @can('setting.index')
                                ...
                                {{-- Neeche ke named routes exist nahi (setting.home.page.setup, setting.smtp.setup, setting.social.media.setup) --}}
                                {{-- <a href="{{ route('setting.home.page.setup') }}" class="subMenu hasCount">{{ __('Site Settings') }}</a> --}}
                                {{-- <a href="{{ route('setting.smtp.setup') }}" class="subMenu hasCount">{{ __('SMTP Settings') }}</a> --}}
                                {{-- <a href="{{ route('setting.social.media.setup') }}" class="subMenu hasCount">{{ __('Social Media Settings') }}</a> --}}
                            @endcan
