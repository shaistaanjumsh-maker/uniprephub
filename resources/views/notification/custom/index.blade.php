...
@section('header-title')
    <h3 class="title">{{ __('Custom Notification List') }}</h3>
@endsection
...
@section('content')
    ...
    <div class="app-main-outer">
        <div class="app-main-inner">
            ...
            <form action="{{ route('admin.notification.custom.send.message') }}" method="POST">
                @csrf
                <div class="row">
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <div class="table-responsive mt-2">
                                    <table id="dataTable" class="table table-striped align-middle modern-table" id="myTable"
                                        style="overflow: auto;">
                                        <thead>
                                            <tr>
...
@push('scripts')
    ...
    <script>
        function scopeFilter(event) {
            ...
            let url = "{{ route('admin.notification.custom.index') }}?user_scope_filter=" + queryValue;
