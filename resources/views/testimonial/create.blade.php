...
@section('header-title')
    <h3 class="title">{{ __('New Testimonial') }}</h3>
@endsection
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" name="designation" id="designation"
                                                    ...
                                                    value="{{ old('designation') }}" maxlength="60"
                                            ...
                                            <div class="mb-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="8"
                                                        placeholder="{{ __('Enter description') }}" maxlength="250" onchange="updateDescriptionCharCount()">{{ old('description') ?? '' }}</textarea>
                                                ...
                                                <div class="mb-3 d-flex justify-content-center">
                                                    <div style="width: 150px; height:150px; border-radius: 50%;">
                                                        <img id="courseImagePreview"
                                                            src="{{ asset('assets/images/media/hero.png') }}"
                                                            class="w-100 h-100"
                                                    ...
                                                    <div id="full-stars-example-two">
                                                        <div class="rating-group">
                                                            <input disabled checked
                                                                class="rating__input rating__input--none" name="rating"
