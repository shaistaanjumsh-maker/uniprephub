                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="payment_upi_id" class="form-label">{{ __('UPI ID') }} <span
                                                class="text-danger fw-bold">*</span></label>
                                        <input type="text" class="form-control" id="payment_upi_id"
                                            name="payment_upi_id" value="{{ $setting->payment_upi_id ?? '' }}"
                                            placeholder="uphc.hammad@axl" />
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="payment_whatsapp" class="form-label">{{ __('Payment WhatsApp') }} <span
                                                class="text-danger fw-bold">*</span></label>
                                        <input type="text" class="form-control" id="payment_whatsapp"
                                            name="payment_whatsapp" value="{{ $setting->payment_whatsapp ?? '' }}"
                                            placeholder="919891460883" />
                                        @error('payment_whatsapp')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 my-auto">
                                        <div class="mb-3 d-flex justify-content-center">
                                            <img id="paymentQRImagePreview" src="{{ $setting->paymentQRPath ?? 'https://placehold.jp/100x100.png' }}"
                                                style="width:100px; height:100px; border-radius:1rem; object-fit: contain">
                                        </div>
                                        <div>
                                            <h4 class="form-label">{{ __('Payment QR Code') }}(JPG, JPEG, PNG)*
                                            </h4>
                                            <label for="formPaymentQRImage" class="w-100 border rounded-3">
                                                <div class="d-flex justify-content-center align-items-center gap-2 p-3"
                                                    style="width: 160px; background-color: #EDEEF1">
                                                    <span>{{ __('Choose a file') }}</span>
                                                    <img src="/assets/images/media/file-plus.svg">
                                            ...
                                            <input name="payment_qr_code" class="form-control form-control-lg"
                                                id="formPaymentQRImage" type="file" hidden
                                                onchange="document.getElementById('paymentQRImagePreview').src = window.URL.createObjectURL(this.files[0])" />
                                        </div>
