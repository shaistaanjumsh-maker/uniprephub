                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4>{{ __('Roles') }}</h4>
                            <form action="{{ route('admin.role.store') }}" method="POST" class="pb-3">
                                @csrf
                            ...
                            @forelse ($roles as $role)
                                <div
                                    ...
                                    <a href="{{ route('admin.role.get_permission', $role->id) }}"
                                    ...
                                    <div>
                                        @if ($role->name !== 'admin' && $role->name !== 'instructor' && $role->name !== 'organization')
                                            <div class="icons d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('admin.role.delete', $role->id) }}"><img
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 permission-container flex-grow-1">
                                ...
                                @if (request()->routeIs('role.get_permission'))
                                    <form action="{{ route('admin.role.assign_roletopermission', $roleId) }}" method="POST">
                                        @csrf
