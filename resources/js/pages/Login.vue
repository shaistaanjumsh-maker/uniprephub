...
const loginUser = async () => {
    try {
        ...
        // Redirect to premium course or checkout if needed, otherwise dashboard
        if (localStorage.getItem("premium_redirect_url")) {
            router.push(localStorage.getItem("premium_redirect_url"));
            localStorage.removeItem("premium_redirect_url");
        } else if (localStorage.getItem("handle_course_id")) {
